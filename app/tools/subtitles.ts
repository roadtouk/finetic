...
export const createSkipToSubtitleContent = (currentMedia: any) => tool({
  description:
...
export const createExplainScene = (currentMedia: any) => tool({
  description:
...
export const createAnalyzeMedia = (currentMedia: any) => tool({
  description:

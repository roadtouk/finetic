...
export const currentMediaWithSourceAtom = atom<CurrentMediaWithSource | null>(null);
...
export const playMediaAtom = atom(
  null,
  (get, set, media: MediaToPlay) => {
...
export const skipToTimestampAtom = atom(
  null,

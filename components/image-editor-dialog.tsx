                    ...
                    {Array.from({ length: 6 }).map((_, index) => {
                      ...
                      return (
                        <Card key={index} className="overflow-hidden py-0 gap-0">
                          <div className={`relative ${getSkeletonAspectRatio(key)} p-3`}>
                        ...
                        >
                          ...
                          <CardContent className="p-3">
                            <div className="space-y-3">
                              ...
                              {/* Rating and Votes */}
                              <div className="flex gap-2">
                                <Badge variant="secondary" className="flex-1 text-xs flex items-center justify-center gap-1">
                                  <Star className="h-3 w-3 fill-yellow-400 text-yellow-400" />
                                  {image.CommunityRating?.toFixed(1) || "N/A"}
                                </Badge>
                                <Badge variant="outline" className="flex-1 text-xs flex items-center justify-center gap-1">
